...
normal likelihood whose mean $\mu(X_F)=m(u^{(t)}, X^F)$ and whose covariance $\Sigma(X_F) \sim \sigma^2
...
core hours on a supercomputer.  That simply cannot be embedded in a Metropolis
...
15{,}000$ pixels) for each $u$-value, a non-starter without adjustment.  Most
