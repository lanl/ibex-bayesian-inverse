...
conditioning sets in IBEX. Therefore, observations are depending on information
...
% SECTION 4: Synthetic IBEX Satellite Data
\section{Synthetic IBEX Satellite Data}
\label{sec:synth_data}

%% Overview
%%% Another review of the heliosphere <- maybe about historical heliospheric research
%%%%% Previous observations were made by Voyager 1 and Voyager 2
%%% IBEX launched to validate and inform this
%%% What did IBEX see?
%%% Behavior of ENAs: inner and outer
%%% What are ENAs important?
% Physicists have spent the last 15-20 years developing theories to explain the
% existence of the \textit{ribbon} and how it's presence fits in the process that
% governs the makeup of heliosphere. First, 

% inner-heliospheric

%% Computer Models:
%%% Explain computer models more in-depth
%%% Yifan: parallel mean free path / perpendicular mean free path. What do those represent? What happens when changing them?
%%% Eric: adindex and kappa. What do these represent and do?
%%% Leverage these models to validate our framework

%% Experiment:
%%% What is the set up? How is data generated? How do we calculate "true" underlying rate? What about exposure time and locations? How do we do hold out? Similar to experiments in Section 3.
%%% Show the results
%%% Commentary on the results
%%% Now that they are validated, move on to the real thing.
