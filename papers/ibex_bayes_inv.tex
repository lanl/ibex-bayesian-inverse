...
\caption{Posterior distributions of sampled model parameters $u$ for each unique
combination of values that has been treated as a holdout set. Blue stars indicate the ``true'' u from which the data was simulated.
