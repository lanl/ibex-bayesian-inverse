...
particlar interest is the behavior at the edge of the heliosphere, known as
the heliopause. Here, highly energized hydrogen ions that make up the solar
wind interact with neutral atoms, occasionally exchange electrons, and become
neutral themselves. These energetic neutral atoms (ENAs) are unaffected by
magnetic fields and therefore travel in a straight line. Some ENAs eventually
...
ENA that enters the detector, providing sufficient data to estimate the rate
...
Sky maps are useful for understaning the heliosphere's creation and
evolution.
...
interstellar space. At the outset of IBEX's mission, scientists expected to
see an elevated rate of ENAs being generated at the front (nose) and back
(tail), much like the turbulent interaction between a boat and water at it's
bow and stern. And indeed, that belief was validated by IBEX data. Regions of
raised ENA rates are known as \textit{globally distributed flux}, or GDF. More
ENAs are produced at the nose and tail where there is an increased number of
collisions between hydrogen ions and neutral particles in the interstellar
medium. However, in a completely unanticipated finding, IBEX also recorded a
thin string of higher rates of ENAs \citep{fuselier2009IBEXribbon} wrapping
around the heliosphere. Scientists now refer to this phenomenom as the
\textit{ribbon}. This unique feature of a \textit{sky map} is clearly visible
in Fig. \ref{f:fig1}. Since this discovery, space scientists have proposed
several theories describing the physical process that generates the ribbon
...
\citet{bayarri2009modularization}, by both necessity and preference. That is,
...
motivation \citet{bayarri2009modularization} cite to their modularized
