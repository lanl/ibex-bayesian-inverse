...
posterior mean of $u_f$; 2) over a fine grid of ratio, with parallel mean
free path fixed at the posterior mean; and 3) over a fine grid of both
parallel mean free path and ratio. We calculate CRPS for all predictions.
