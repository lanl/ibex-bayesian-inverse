...
\caption{Posterior distributions $u \mid Y^F$ and 95\% HPD intervals for each
unique model parameter $u$ that has been treated as a holdout set. Blue stars
indicate the value $u^*$ from which the data was simulated.
