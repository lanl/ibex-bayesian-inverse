...
Many computer models to generate sky maps exist (???). In this paper we focus on two. One simulation to create variations of the GDF and one that offers and explanation of how the ribbon is produced. \citet{zirnsteinGDFsims2015} developed a model to replicate the generation of ENAs at the GDF based on two parameters, param1 and param2.
