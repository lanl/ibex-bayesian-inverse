...
Now, in each of these examples the data has been limited ($< 100$). But
suppose we somehow were able to get hundreds, if not thousands, of simulation
runs. In that situation, GPs face a computational hurdle that can severely
limit their use. We address this concern next.
...
One weakness of GPs is the need to decompose an $n \times n$ covariance matrix, making
