...
\begin{itemize}
  ...
  \item Calibration is SUPER novel in this field
  \item Summary of work done on computer model calibration
  \item Reference Dave's work on calibration. Wanted to do it, but had to do PCA stuff do to computational limits
  \item Summary of work modeling Poisson data in the context of computer model calibration
  \item Mention that Katzfuss and Lawrence suggested use of SVecchia in calibration
