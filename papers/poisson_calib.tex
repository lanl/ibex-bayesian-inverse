...
collected by IBEX computer models.
...
to the limited computer output in order to provide fast predictions out of
...
focus on Poisson-distributed data), 2) Allow for large-scale, high-dimensional
computer model output, and 3) For the first time, illustrate how IBEX data in
its raw form can be used to make inferential claims about heliosphere.
