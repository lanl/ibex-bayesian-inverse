...
Display distributions on calibration parameters that show the method is able to recover the truth


Show prediction results on hold out data (RMSE? Score? Visual?)
