...
\includegraphics[scale=0.6, trim=5 15 15 50,clip=TRUE]{logit1_est.pdf}
\includegraphics[scale=0.6, trim=5 15 15 50,clip=TRUE]{logit1_post_draws.pdf}
\caption{RMSE and CRPS on IBEX holdout data, comparing Scaled Vecchia Gaussian Processes, Locally
Approximated Gaussian Processes, Fully Bayesian Gaussian Processes, and SEPIA.
