...
sample_pmfps <- seq(500, 3000, length=500)
sample_pmfps_cod <- (sample_pmfps - 500)/2500
sample_ratios <- seq(0.001, 0.1, length=500)
...
metrics <- list(crps_pmfp=crps_pmfp, crps_ratio=crps_ratio, post_means=post_means)
